		...
		return args -> {
			...
			if (serviceCtg.listarCategorias().isEmpty()) {
				...
				if (service.getListaProductos().isEmpty()) {
					service.guardarProducto(new Producto("Impresora Ecotank L1250", 335699, 5, impresora, "La impresora Epson Ecotank L1250 es compacta y ligera, diseñada para ocupar poco espacio. Con ella podrás imprimir con gran calidad cualquier documento. Además, cuenta con impresión de fotos optimizada, que mejora los tonos negros para dar excelentes texturas, sombras y contrastes en alta resolución", "Epson", "https://i.ibb.co/G4SHTXGH/a51ba38cc959.jpg"));
